...
--
-- Host: 127.0.0.1
-- Tempo de geração: 01-Jun-2022 às 02:14
...
--
DROP DATABASE IF EXISTS `bdordemdeservico`;
CREATE DATABASE IF NOT EXISTS `bdordemdeservico` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `endereco` varchar(100) utf8mb4_unicode_ci NOT NULL,
  `telefone` varchar(50) utf8mb4_unicode_ci NOT NULL,
  `senha` varchar(250) utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
--
ALTER TABLE `cliente`
  ADD CONSTRAINT `cliente_ibfk_1` FOREIGN KEY (`IDFUN_FK`) REFERENCES `cliente` (`IDCLI`);

--
-- Limitadores para a tabela `empresa`
--
ALTER TABLE `empresa`
  ADD CONSTRAINT `empresa_ibfk_1` FOREIGN KEY (`IDOS_FK`) REFERENCES `empresa` (`IDEMP`);

--
-- Limitadores para a tabela `itenservico`
--
ALTER TABLE `itenservico`
  ADD CONSTRAINT `itenservico_ibfk_1` FOREIGN KEY (`IDOS_FK`) REFERENCES `itenservico` (`IDIS`),
  ADD CONSTRAINT `itenservico_ibfk_2` FOREIGN KEY (`IDSER_FK`) REFERENCES `itenservico` (`IDIS`);

--
-- Limitadores para a tabela `itensproduto`
--
ALTER TABLE `itensproduto`
  ADD CONSTRAINT `itensproduto_ibfk_1` FOREIGN KEY (`IDOS`) REFERENCES `itensproduto` (`IDIP`),
  ADD CONSTRAINT `itensproduto_ibfk_2` FOREIGN KEY (`IDPRO_FK`) REFERENCES `itensproduto` (`IDIP`);

--
-- Limitadores para a tabela `ordemdeservico`
--
ALTER TABLE `ordemdeservico`
  ADD CONSTRAINT `ordemdeservico_ibfk_1` FOREIGN KEY (`IDEMP_FK`) REFERENCES `ordemdeservico` (`IDOS`),
  ADD CONSTRAINT `ordemdeservico_ibfk_2` FOREIGN KEY (`IDFUN_FK`) REFERENCES `ordemdeservico` (`IDOS`),
  ADD CONSTRAINT `ordemdeservico_ibfk_3` FOREIGN KEY (`IDCLI_FK`) REFERENCES `ordemdeservico` (`IDOS`),
  ADD CONSTRAINT `ordemdeservico_ibfk_4` FOREIGN KEY (`IDIP_FK`) REFERENCES `ordemdeservico` (`IDOS`),
  ADD CONSTRAINT `ordemdeservico_ibfk_5` FOREIGN KEY (`IDIS_FK`) REFERENCES `ordemdeservico` (`IDOS`);
COMMIT;
