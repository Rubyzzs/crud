...
--
-- Host: 127.0.0.1
-- Tempo de geração: 07-Jun-2022 às 01:11
...
CREATE TABLE `usuarios` (
  ...
  `nomeUSU` varchar(220) NOT NULL,
  `emailUSU` varchar(220) NOT NULL,
  `enderecoUSU` varchar(100) NOT NULL,
  `telefoneUSU` varchar(50) NOT NULL,
  `senhaUSU` varchar(250) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
